...
export const repeaterProtocolSchema = z.object({
  ...
  setRestSeconds: z.number().min(0, "Set rest minutes must be 0 or greater."),
  countdownSeconds: z.number().min(0, "Countdown seconds must be 0 or greater."),
  audioCues: z.boolean(),
  countdownBeeps: z.boolean(),
});

export type RepeaterProtocolFormValues = z.infer<typeof repeaterProtocolSchema>
