...
export type NumericFieldName = FieldPathByValue<RepeaterProtocolFormValues, number>
export type ToggleFieldName = FieldPathByValue<RepeaterProtocolFormValues, boolean>
...
export const repeaterProtocolNumericFields: Record<NumericFieldName, NumericFieldDefinition> = {
...
export const repeaterProtocolToggleFields: Array<{ name: ToggleFieldName; label: string; description: string }> = [
  {
    name: "audioCues",
    label: "Audio Cues",
